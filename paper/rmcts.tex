...
See \url{github.com/bhoward73/rmcts} for an efficient C implementation of \RMCTS.
...
We find it reassuring that every action $a$ is guaranteed to receive at least $\lfloor \pi_0(s,a) N \rfloor$ simulations.
